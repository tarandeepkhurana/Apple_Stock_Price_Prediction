...
import logging
import os
from src.apple.data_preprocess import split_dataset

#Ensures logs directory exists
log_dir = 'logs/apple' 
os.makedirs(log_dir, exist_ok=True)

logger = logging.getLogger('lgbm_features')
logger.setLevel("DEBUG")

console_handler = logging.StreamHandler()
console_handler.setLevel("DEBUG")

file_path = os.path.join(log_dir, 'lgbm_features.log')
...
def new_features() -> None:
    ...
    try:
        ...
        save_to = 'data/feature_engineered/apple/lgbm/stock_data_new.csv'
