...
def tune_model():
    ...
    X_train = pd.read_csv("data/train/apple/rf/X_train.csv")
    y_train = pd.read_csv("data/train/apple/rf/y_train.csv")
    X_test = pd.read_csv("data/test/apple/rf/X_test.csv")
    y_test = pd.read_csv("data/test/apple/rf/y_test.csv")
    ...
    with mlflow.start_run():
        ...
        #SAVING THE MODEL
        joblib.dump(model, 'models/apple/rf_model.pkl')
