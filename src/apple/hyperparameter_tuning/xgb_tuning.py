...
def tune_model():
    ...
    X_train = pd.read_csv("data/train/apple/xgb/X_train.csv")
    y_train = pd.read_csv("data/train/apple/xgb/y_train.csv")
    X_test = pd.read_csv("data/test/apple/xgb/X_test.csv")
    y_test = pd.read_csv("data/test/apple/xgb/y_test.csv")
    ...
    with mlflow.start_run():
        ...
        #SAVING THE MODEL
        joblib.dump(model, 'models/apple/xgb_model.pkl')
