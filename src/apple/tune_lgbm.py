...
file_path = os.path.join(log_dir, 'lightgbm.log')
...
def tune_model():
    """
    Trains the LGBMRegressor model on the preprocessed stock price data
    """
    # Load params.yaml
    ...
    mlflow.set_experiment('Model_Tune_LGBM')
    ...
    with mlflow.start_run():
        ...
        joblib.dump(model, 'models/lightgbm/best_model.pkl')
