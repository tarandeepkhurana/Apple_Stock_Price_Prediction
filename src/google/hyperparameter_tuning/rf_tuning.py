...
logger = logging.getLogger('rf_tuning')
logger.setLevel("DEBUG")

console_handler = logging.StreamHandler()
console_handler.setLevel("DEBUG")

file_path = os.path.join(log_dir, 'rf_tuning.log')
...
def tune_model():
    ...
    X_train = pd.read_csv("data/train/google/rf/X_train.csv")
    y_train = pd.read_csv("data/train/google/rf/y_train.csv")
    X_test = pd.read_csv("data/test/google/rf/X_test.csv")
    y_test = pd.read_csv("data/test/google/rf/y_test.csv")
    ...
    with mlflow.start_run():
        ...
        html_path = f"artifacts/RandomForest_feature_importance.html" 
        ...
        #SAVING THE MODEL
        joblib.dump(model, 'models/google/rf_model.pkl')
